...
3. a compiled markdown file that is properly displayed here using your broser [link]
(https://github.com/ivanjvaliente/Practical-Machine-Learning-Project/blob/master/Practical_Machine_Learning_Project.md)
